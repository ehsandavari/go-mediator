...
func registerRequestHandler[TRequest any, TResponse any](handler any) IError {
...
func buildRequestHandler[TRequest any, TResponse any](handler any) (iRequestHandler[TRequest, TResponse], bool) {
	...
	if !ok {
		factory, ok := handler.(TRequestHandlerFactory[TRequest, TResponse])
		if !ok {
			return nil, false
		}
...
func buildNotificationHandler[TNotification any](handler any) (iNotificationHandler[TNotification], bool) {
	...
	if !ok {
		factory, ok := handler.(TNotificationHandlerFactory[TNotification])
		if !ok {
			return nil, false
		}
